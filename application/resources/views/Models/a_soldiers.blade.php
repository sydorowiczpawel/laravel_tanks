...
<div class="container">
  <div>
    <a href="a_soldiers"><button class="btn btn-warning btn-sm" type="button">Soldiers</button></a>
    <a href=""><button class="btn btn-outline-warning btn-sm">Tanks</button></a>
    <a href=""><button class="btn btn-outline-warning btn-sm">Documents</button></a>
    <a href="addSoldier">
  ...
  <table class="table table-striped table-hover">
    ...
    <tr>
      ...
      <td>
        ...
        {{-- Edytuj --}}
        <button class="btn btn-warning btn-sm">
          <a href="editSoldier/{{ $object -> pass_number }}">
